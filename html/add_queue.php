...
<form class='form' method='post'
        ...
        <fieldset>
                ...
                <div class='form-group'>
                        <label for='ldap_group_input'>LDAP Group
                                (optional):</label>
                                <input class='form-control' type='text' name='ldap_group'
                                        id='ldap_group_input'
                                        value='<?php if (isset($_POST['ldap_group'])) { echo $_POST['ldap_group']; } ?>'>
                </div>
                <div class='form-group'>
                        <label for='cpu_input'>CPU Cost (per second): </label>
                                <input class='form-control' type='text' name='cpu_cost'
                                        id='cpu_input'
                                        value='<?php if (isset($_POST['cpu_cost'])) { echo $_POST['cpu_cost']; } ?>'>
                </div>
                <div class='form-group'>
                        <label for='mem_input'>Memory Cost (per
                                gigabyte): </label>
                                <input class='form-control' type='text' name='mem_cost'
                                        id='mem_input'
                                        value='<?php if (isset($_POST['mem_cost'])) { echo $_POST['mem_cost']; } ?>'>
                </div>
                <div class='form-group'>
                        <label for='gpu_input'>GPU Cost (per second): </label>
                                <input class='form-control' type='text' name='gpu_cost'
                                        id='gpu_input'
